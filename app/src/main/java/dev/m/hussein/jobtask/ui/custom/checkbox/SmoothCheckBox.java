package dev.m.hussein.jobtask.ui.custom.checkbox;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        mChecked = ta.getBoolean(R.styleable.SmoothCheckBox_checked, false);
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, (int) Utils.dp2px(getResources(), 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = (int) Utils.dp2px(getResources(), DEF_DRAW_SIZE);
